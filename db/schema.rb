...
ActiveRecord::Schema.define(version: 2020_04_28_171856) do
  ...
  create_table "authhorizations", force: :cascade do |t|
    t.bigint "user_id"
    t.string "provider"
    t.string "uid"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_authhorizations_on_user_id"
  end
